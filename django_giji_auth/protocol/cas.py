...
from django_giji_auth.session import create_session_token
from django_giji_auth.settings import auth_settings
from django_giji_auth.models import UserProxy
...
def cas_set_redirect_url(sendback, request):
    absolute_url = request.build_absolute_uri(
        reverse('django_giji_auth:cas-service-validate-link'))
